  ...
  return (
    <PageContent width="95%" maxWidth="1200px" center gutters style={{ position: 'relative' }}>
      ...
      <section>
        ...
        <BulletedList>
          <ListItem primary={ <ExternalLink to="https://bdcatalyst.gitbook.io/biodata-catalyst-consortium-guidance/strategic-planning/strategic-planning#strategic-planning-documents-reviewed-and-approved-by-nhlbi-leadership">Data Management Strategy V1.0</ExternalLink> } />
